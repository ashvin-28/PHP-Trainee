...
<button type="button" class="btn btn-primary"  style="width: 50px; margin: 2px 2px 2px 20px; padding: 2px;" data-bs-toggle="modal" data-bs-target="#adminPopupForm">
    Add 
</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="adminPopupFormLabel">Employee Table</h5>
